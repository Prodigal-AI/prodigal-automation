...
def mock_content_generator():
    ...
    mock_generator.generate_simple_content.return_value = (
        "This is a test tweet content generated by the mock."
    )
    return mock_generator


def test_create_tweet_integration(mock_twitter_api, mock_content_generator):
    """Integration test for create_tweet method,
    simulating interaction with Twitter API and ContentGenerator."""
