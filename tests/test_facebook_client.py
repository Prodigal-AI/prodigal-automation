...
class TestFacebookClient(unittest.TestCase):
    ...
    def test_initialize_graph_api_error(self, MockGraphAPI):
        ...
        with self.assertRaisesRegex(
            ConnectionError, "Failed to initialize Facebook client: Test API Error"
        ):
            client.initialize()
    ...
    def test_put_object_not_initialized(self, MockGraphAPI):
        ...
        with self.assertRaisesRegex(
            RuntimeError, "FacebookClient is not initialized. Call .initialize() first."
        ):
    ...
    def test_delete_object_success(self, MockGraphAPI):
        ...
        self.assertEqual(
            result,
            {"success": True, "message": f"Object {object_id} deleted successfully."},
        )
